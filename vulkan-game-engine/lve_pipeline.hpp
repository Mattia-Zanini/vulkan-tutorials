...
namespace lve {
    ...
    struct PipelineConfigInfo {
        // Viewport: descrive la trasformazione dalle coordinate normalizzate di output [-1, 1] ai pixel dell'immagine target
        VkViewport viewport;
        // Scissor: definisce un rettangolo di ritaglio; qualunque pixel al di fuori viene scartato
        VkRect2D scissor;
        // Combina viewport e scissor nello stato della pipeline
